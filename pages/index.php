...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom-2">
    <div class="container-fluid">
        ...
        <a href="index.php" class="logo navbar-brand fw-bold"><span></span><span
                    style="color: #28C7FA">Spaces</span></a>
...
<main>
    ...
    <script defer>
        ...
        if (isLogin == true) {
            ...
            '<div class="content">' +
                '   <h1 class="">Spaces</h1>' +
                '   <p class="">Customize your space according to you</p>' +
                '   <div class="actionbtn">' +
