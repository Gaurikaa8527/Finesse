        ...
        <div class="col-md-4">
            <div class="box">
                <div class="our-services settings">
                    ...
                    <h4>Doorstep & Instant Delivery</h4>
                    <p>Enjoy our doorstep instant delivery from the comfort of your home!</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="box">
                <div class="our-services speedup">
                    ...
                    <h4>Warranty</h4>
                    <p>Get a one year warranty on each product! You can even get it extended upto 3 years by paying a negligible amount!</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="box">
                <div class="our-services privacy">
                    ...
                    <p>Be carefree and sure about what you invest in because we offer a 30 day return policy, no questions asked!</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="box">
                <div class="our-services database">
                    ...
                    <h4>24h/24</h4>
                    <p>Our service is open 24h on 24h, so that our customers have access to our products all the time!</p>
                </div>
            </div>
        </div>
    </div>
